...
void oled_task_user(void) {
    ...
    get_current_wpm();
    // Removed wpm count as there isn't enough room for sprintf
    // sprintf( (char **) wpm_str, "WPM:%03d", get_current_wpm());  // edit the string to change what shows up, edit %03d to change how many digits show up
